...
class CalculatorPanel extends JPanel {
    ...
    private JPanel createOperationPanel() {
        ...
        addButton(commandPanel, "AC", command);
        addButton(commandPanel, "(", command);
        addButton(commandPanel, ")", command);
        addButton(commandPanel, "=", command);

        for (Map.Entry<String, Plugin> plugin : pluginLoader.getPlugins().entrySet()) {
            JButton button = addButton(commandPanel, plugin.getValue().operatorName(), command);
    ...
    private JPanel createNumberPanel() {
        ...
        Arrays.stream(buttons).forEach(name -> addButton(numberPanel, name, insert));
        return numberPanel;
    }

    private JButton addButton(JPanel panel, String label, ActionListener listener) {
